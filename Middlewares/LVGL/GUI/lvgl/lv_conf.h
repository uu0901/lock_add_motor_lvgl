...
#define LV_MEM_CUSTOM          1                          /* 0：使用LVGL自带的内存管理，1：使用自研内存管理 */
...
//        #define LV_MEM_POOL_INCLUDE      "malloc.h"    /* 头文件路径 */
//        #define LV_MEM_POOL_ALLOC       lv_mymalloc          /* 内存分配函数 */
    #endif
#else                                                       /* 使用自研内存管理 */

    #define LV_MEM_CUSTOM_INCLUDE       "malloc.h"          /* 头文件路径 */
    #define LV_MEM_CUSTOM_ALLOC         lv_mymalloc              /* 内存分配函数 */
    #define LV_MEM_CUSTOM_FREE          lv_myfree                /* 内存释放函数 */
    #define LV_MEM_CUSTOM_REALLOC       lv_myrealloc             /* 内存重新分配函数 */
